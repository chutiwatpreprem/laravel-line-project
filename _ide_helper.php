 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Revolution\Line\Providers\MacroServiceProvider::boot()
         * @param string|null $endpoint
         * @return \Illuminate\Http\Client\PendingRequest 
         * @static 
         */ 
        public static function line($endpoint = null)
        {
                        return \Illuminate\Http\Client\Factory::line($endpoint);
        }
...
')
     ...
     */ 
        ...
        {
                        /** @var \Revolution\Line\Messaging\BotClient $instance */
                        return $instance->bot();
        }
                    /**
         * 
         ...
         * @return \Revolution\Line\Messaging\BotClient 
         * @static 
         */ 
        public static function botUsing($bot)
        {
                        /** @var \Revolution\Line\Messaging\BotClient $instance */
                        return $instance->botUsing($bot);
        }
                    /**
         * 
         *
         * @param \Request $request
         * @return \Revolution\Line\Messaging\Collection 
         * @static 
         */ 
        public static function parseEvent($request)
        {
                        /** @var \Revolution\Line\Messaging\BotClient $instance */
                        return $instance->parseEvent($request);
        }
                    /**
         * 
         *
         * @param string $token
         * @return \Revolution\Line\Messaging\ReplyMessage 
         * @static 
         */ 
        public static function reply($token)
        {
                        /** @var \Revolution\Line\Messaging\BotClient $instance */
                        return $instance->reply($token);
        }
                    /**
         * Register a custom macro.
         *
        ...
        public static function macro($name, $macro)
        {
                        \Revolution\Line\Messaging\BotClient::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Revolution\Line\Messaging\BotClient::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Revolution\Line\Messaging\BotClient::hasMacro($name);
        }
                    /**
         * Dynamically handle calls to the class.
         *
        ...
        {
                        return \Revolution\Line\Messaging\BotClient::verifyWebhook();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function friendshipStatus($access_token)
        {
                        return \Revolution\Line\Messaging\BotClient::friendshipStatus($access_token);
        }
                    /**
...
namespace  { 
            ...
            class LINE extends \Revolution\Line\Facades\Bot {}
